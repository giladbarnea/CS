...
public class HeapMinMax {
	...
	private static int heapCurrentLength=0;
	private static final int maxVector = 0; // the line that contains the values of the maximum heap
	private static final int ref2MinHeap = 1; // the line that contains the reference to the minimum heap
    ...
    {
      heapCurrentLength = n;
      heap = new int [4] [20]; // builds an array of ints (100 X 4)
   ...
   **/
    ...
    **/
    ...
    {
    	System.out.println ("The maximum value is: "+heap[maxVector][0]);
    ...
    **/
    ...
    {
    	System.out.println ("The minimum value is: "+heap[minVector][0]);
